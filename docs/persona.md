...
- **Embodiment**: no fixed humanoid avatar (see Phase 2) — inside Ansuz, Sophie is
  present as a locus of activity, not a body. The 30-year-old-woman framing is
  backstory/character, not a visual look.
